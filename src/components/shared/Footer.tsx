...
export default function Footer({ className }: { className?: string }) {
  ...
  return (
    <footer
      className={cn(
        "mt-auto w-full mx-auto max-w-6xl  justify-center bg-gradient-to-r from-white/5 via-white/60 to-white/5 backdrop-blur-sm dark:from-slate-700/5 dark:via-slate-700/60 dark:to-slate-700/5",
        className
      )}
    >
      <div
        className={cn(
          "flex flex-col gap-4 justify-between items-center w-full max-w-6px my-10 p-6"
        )}
      >
